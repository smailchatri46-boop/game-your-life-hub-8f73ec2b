  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // Single text marquee - scrolls right to left, fades out smoothly, reappears from right
        "marquee-single": {
          "0%": { transform: "translateX(0%)", opacity: "1" },
          "40%": { transform: "translateX(-60%)", opacity: "1" },
          "48%": { transform: "translateX(-80%)", opacity: "0.5" },
          "52%": { transform: "translateX(-100%)", opacity: "0" },
          "53%": { transform: "translateX(100%)", opacity: "0" },
          "60%": { transform: "translateX(60%)", opacity: "0.5" },
      ...
      animation: {
        ...
        "marquee-single-0": "marquee-single 18s ease-in-out infinite",
        "marquee-single-1": "marquee-single 20s ease-in-out infinite 1.5s",
        "marquee-single-2": "marquee-single 17s ease-in-out infinite 3s",
        "marquee-single-3": "marquee-single 21s ease-in-out infinite 0.8s",
        "marquee-single-4": "marquee-single 19s ease-in-out infinite 4s",
        "marquee-single-5": "marquee-single 16s ease-in-out infinite 2.2s",
      },
    },
  },
