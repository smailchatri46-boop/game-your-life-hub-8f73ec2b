  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // Single text marquee - scrolls out completely then reappears with smooth opacity fade
        "marquee-single": {
          "0%": { transform: "translateX(0%)", opacity: "1" },
          "35%": { transform: "translateX(-70%)", opacity: "1" },
          "45%": { transform: "translateX(-100%)", opacity: "0" },
          "45.01%": { transform: "translateX(100%)", opacity: "0" },
          "55%": { transform: "translateX(70%)", opacity: "0" },
          "65%": { transform: "translateX(30%)", opacity: "1" },
      ...
      animation: {
        ...
        "marquee-single-0": "marquee-single 12s ease-in-out infinite",
        "marquee-single-1": "marquee-single 14s ease-in-out infinite 0.8s",
        "marquee-single-2": "marquee-single 11s ease-in-out infinite 1.5s",
        "marquee-single-3": "marquee-single 13s ease-in-out infinite 0.3s",
        "marquee-single-4": "marquee-single 15s ease-in-out infinite 2s",
        "marquee-single-5": "marquee-single 10s ease-in-out infinite 1.2s",
      },
    },
  },
