    ...
    <section className="py-14 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-center mb-6">
          <GlassCard className="p-5 hover:shadow-large transition-all duration-300 w-full max-w-md">
            {/* Paragraph inside card */}
            <p className="text-muted-foreground text-sm text-center mb-5">
              Create meaningful goals, link them to your daily habits and tasks, and watch your progress grow. Stay motivated with visual progress tracking and pace indicators.
            </p>
