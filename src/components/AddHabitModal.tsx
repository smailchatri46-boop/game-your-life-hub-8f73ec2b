...
export function AddHabitModal({ open, onOpenChange, onSave, skipGuidance = false }: AddHabitModalProps) {
  ...
  const canProceed = () => {
    ...
    switch (habitStep) {
      ...
      case 4: return habitType === "boolean" || numericTarget > 0;
      case 5: 
      ...
      <DialogContent className="sm:max-w-lg p-0 overflow-hidden bg-gradient-to-br from-[hsl(30,100%,98%)] to-[hsl(25,80%,95%)] border-0" hideCloseButton>
        <div className="p-6">
          ...
          <div className="min-h-[300px] flex flex-col">
            ...
            {/* Habit Step 4: Choose type (checkbox vs numeric) */}
            {!isGuidancePhase && habitStep === 4 && (
              <div className="space-y-4">
                <div className="text-center mb-6">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    Choose between a simple checkbox or counting
                  </p>
                </div>
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">Mark as done or not done each day</p>
                    </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p className="font-medium text-foreground">Count-based</p>
                        <p className="text-xs text-muted-foreground">Track a number (e.g., 8 glasses of water)</p>
                      </div>
                      <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all ${
                    ...
                    {habitType === "numeric" && (
                      <div className="mt-3 p-4 bg-white/60 rounded-2xl">
                        ...
                        <div className="flex items-center gap-4">
                          <button
                            ...
                            className="w-10 h-10 rounded-xl bg-muted/50 hover:bg-muted text-foreground font-bold text-lg flex items-center justify-center transition-colors"
                          >
                            −
                          </button>
                          <Input
                            ...
                            max={100}
                            value={numericTarget}
                            onChange={(e) => setNumericTarget(Math.max(1, Math.min(100, parseInt(e.target.value) || 1)))}
                            className="w-20 h-10 text-center text-lg font-semibold bg-white border-border/20 rounded-xl"
                          />
                          <button
                            type="button"
