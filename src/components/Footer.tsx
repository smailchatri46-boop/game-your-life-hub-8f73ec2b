  ...
  return (
    <footer className="mt-16 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Footer card with soft translucency */}
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-soft px-8 py-10">
          {/* Three column grid - left/center/right aligned */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-10">
            {/* Resources - Left */}
            <div className="text-center md:text-left">
              <h4 className="font-body text-sm font-semibold text-foreground mb-4">Resources</h4>
            ...
            <div className="text-center">
              <h4 className="font-body text-sm font-semibold text-foreground mb-4">Company</h4>
              <ul className="space-y-2.5">
            ...
            <div className="text-center md:text-right">
              <h4 className="font-body text-sm font-semibold text-foreground mb-4">Legal</h4>
              <ul className="space-y-2.5">
                {legalLinks.map((link) => (
                  <li key={link.path}>
                    <Link
